...
%Substituting 10Be for 26Al
fs.P10_att_l_fm=fs.P26_att_l_fm
fs.P10_att_l_nm=fs.P26_att_l_nm;
...
for jj=1:length(times)
    ...
    print_string=['../Figures/AppB_time_',num2str(time)];
    ...
    if(jj==length(times))
        ...
        c.Label.String='\epsilon_{C}/\epsilon_{Al}';
        c.FontSize=10;
    end
...
print_string=['../Figures/AppB_SC_26Al14C']
