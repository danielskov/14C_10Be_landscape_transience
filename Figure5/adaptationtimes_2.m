%Caculates the temporal evolution of the apparent erosion following a
...
for j=1:rows
    ...
    %Calculate 10Be and 14C apparent erosion rates
    ...
    %Increases erosion rates by a factor of 10 (now: an increase from
    %100mm/kyr to 1000mm/kyr)
    e_old=e_old*10;
    e_new_faster=e_old*10;
...
%%
%Decreases in erosion rate, from 100mm/kyr to 10mm/kyr
...
for j=1:rows
    ...
    %%Increase erosion rates, so that the model is now
    %%1000mm/kyr-->100mm/kyr
    e_old=e_old*10;
    e_new_faster=e_old/10;
...
set(h,'fontsize',10,'location','northwest','orientation','horizontal')


print_string=['../Figures/Figure5_adaption_times_']
